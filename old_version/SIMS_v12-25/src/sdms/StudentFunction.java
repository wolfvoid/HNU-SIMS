...
public class StudentFunction { //学生功能类
    ...
    public StudentFunction(String stu_num) { //整体界面
        ...
        bt2.addActionListener(new ActionListener() { //选课
        ...
        bt3.addActionListener(new ActionListener() { //我的课程
            public void actionPerformed(ActionEvent e) {
                lb2.setText("[我的课程]");
                pn_function.removeAll();
                studentJFrame.repaint();
        ...
        bt4.addActionListener(new ActionListener() { //进行宿舍报修
            public void actionPerformed(ActionEvent e) {
                lb2.setText("[宿舍报修]");
                pn_function.removeAll();
                studentJFrame.repaint();
        ...
        bt5.addActionListener(new ActionListener() { //进行宿舍反馈
            public void actionPerformed(ActionEvent e) {
                lb2.setText("[宿舍反馈]");
                pn_function.removeAll();
                studentJFrame.repaint();
        ...
        bt6.addActionListener(new ActionListener() { //修改密码
            public void actionPerformed(ActionEvent e) {
                lb2.setText("[修改密码]");
                pn_function.removeAll();
                studentJFrame.repaint();
        ...
        bt7.addActionListener(new ActionListener() { //退出学生模式
            public void actionPerformed(ActionEvent e) {
    ...
    public JTabbedPane select_course() { //[选课]功能
        ...
        tp_selcourse.setFont(new Font("黑体", 0, 25));
        ...
        try { //获取dormitory表信息
            ...
            if (count == 0) { //若dormitory表无元组
                ...
                do { //获取该宿管管理的宿舍楼的所有宿舍信息
                    ...
                    rowData[i][2] = rs.getString("grade"); //分数
                    i++;
                } while (rs.next());
            }
            rs.close();
