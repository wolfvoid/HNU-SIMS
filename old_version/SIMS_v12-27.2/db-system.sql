/*
 ...
 Source Schema         : db-system

 Target Server Type    : MySQL
 Target Server Version : 80035 (8.0.35)
 File Encoding         : 65001

 Date: 27/12/2023 03:03:15
*/
...
-- ----------------------------
INSERT INTO `admin`
VALUES ('1001', '010202', '刘小贰', '男', '4286');
INSERT INTO `admin`
VALUES ('1002', '010206', '梅老陆', '男', '42866');
INSERT INTO `admin`
VALUES ('1003', '010214', '黄拾肆', '女', '43166');
INSERT INTO `admin`
VALUES ('1004', '010218', '龙拾捌', '男', '431666');
INSERT INTO `admin`
VALUES ('1005', '010229', '袁贰玖', '男', '428666');
INSERT INTO `admin`
VALUES ('1006', '010231', '森叁壹', '男', '42886');
...
-- ----------------------------
INSERT INTO `advice`
VALUES ('202108010202', '建议全天24小时提供热水。');
INSERT INTO `advice`
VALUES ('202108010202', '和上一条建议一样');
INSERT INTO `advice`
VALUES ('202108010202', '和上一条建议不一样，但是和第一条建议一样');
...
(
    ...
    `tno`   char(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci    NOT NULL COMMENT '授课教师',
    PRIMARY KEY (`cno`) USING BTREE,
    INDEX `teach` (`tno` ASC) USING BTREE,
    CONSTRAINT `teach` FOREIGN KEY (`tno`) REFERENCES `teacher` (`tno`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- ----------------------------
INSERT INTO `course`
VALUES ('0001', '程序设计', 5, '2001');
INSERT INTO `course`
VALUES ('0002', '高等数学', 5, '2002');
INSERT INTO `course`
VALUES ('0003', '线性代数', 3, '2003');
INSERT INTO `course`
VALUES ('0004', '大学物理', 3, '2004');
INSERT INTO `course`
VALUES ('0005', '电子电路', 5, '2005');
INSERT INTO `course`
VALUES ('0006', '计算机系统', 3, '2006');
INSERT INTO `course`
VALUES ('0007', '数据库系统', 3, '2007');
...
VALUES ('TM25', 1, 428, 4, 1, 300);
INSERT INTO `dormitory`
VALUES ('TM25', 2, 429, 4, 2, 310);
INSERT INTO `dormitory`
VALUES ('TM25', 3, 430, 4, 3, 320);
INSERT INTO `dormitory`
VALUES ('TM25', 4, 431, 4, 4, 330);
INSERT INTO `dormitory`
VALUES ('TM25', 5, 432, 4, 0, 340);
INSERT INTO `dormitory`
VALUES ('TM316', 3, 104, 4, 0, 110);
INSERT INTO `dormitory`
VALUES ('TM316', 4, 103, 4, 4, 120);
INSERT INTO `dormitory`
VALUES ('TM316', 5, 102, 4, 3, 130);
INSERT INTO `dormitory`
VALUES ('TM316', 6, 101, 4, 2, 140);
INSERT INTO `dormitory`
VALUES ('TM316', 7, 433, 4, 1, 150);
INSERT INTO `dormitory`
VALUES ('TM39', 1, 105, 2, 1, 50);
INSERT INTO `dormitory`
VALUES ('TM39', 2, 106, 2, 0, 50);
...
(
    ...
    CONSTRAINT `fk_floor_admin` FOREIGN KEY (`admin_num`) REFERENCES `admin` (`admin_num`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- ----------------------------
INSERT INTO `floor`
VALUES ('TM11', 8, 320, '普通', '男', '1004');
INSERT INTO `floor`
VALUES ('TM25', 7, 140, '豪华', '混合', '1001');
INSERT INTO `floor`
VALUES ('TM316', 7, 280, '普通', '男', '1003');
INSERT INTO `floor`
VALUES ('TM39', 6, 240, '简朴', '女', '1002');
INSERT INTO `floor`
VALUES ('TM47', 7, 210, '豪华', '女', '1005');
INSERT INTO `floor`
VALUES ('TM66', 5, 100, '巨豪华', '男', '1006');
...
-- ----------------------------
INSERT INTO `in_out`
VALUES ('202108010202', 'TM25', '出', '2021-09-30 15:30:21');
INSERT INTO `in_out`
VALUES ('202108010202', 'TM25', '入', '2021-10-07 10:45:01');
INSERT INTO `in_out`
VALUES ('202108010214', 'TM316', '出', '2021-11-13 09:25:00');
...
(
    ...
    CONSTRAINT `layer_ran` CHECK (`layer` > 0),
    CONSTRAINT `room_num_ran` CHECK (`room_num` > 0),
...
-- ----------------------------
INSERT INTO `repair`
VALUES ('202108010202', 'TM25', 1, 428, '宿舍门锁损坏。', '否');
INSERT INTO `repair`
VALUES ('202108010202', 'TM25', 1, 428, '厕所堵塞。', '否');
INSERT INTO `repair`
VALUES ('202108010214', 'TM316', 7, 433, '空调损坏。', '是');
INSERT INTO `repair`
VALUES ('202108010206', 'TM25', 1, 428, '窗户破损。', '否');
INSERT INTO `repair`
VALUES ('202008010218', 'TM39', 2, 106, '水龙头损坏。', '否');
...
(
    ...
    CONSTRAINT `select_cou` FOREIGN KEY (`cno`) REFERENCES `course` (`cno`) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT `select_stu` FOREIGN KEY (`sno`) REFERENCES `student` (`stu_num`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci
  ROW_FORMAT = DYNAMIC;
...
VALUES ('202008010206', '0001', 1);
INSERT INTO `select_course`
VALUES ('202008010206', '0002', NULL);
INSERT INTO `select_course`
VALUES ('202108010214', '0002', NULL);
INSERT INTO `select_course`
VALUES ('202108010214', '0003', 90);
...
(
    ...
    CONSTRAINT `layer_ranger` CHECK (`layer` > 0),
    CONSTRAINT `room_num_ranger` CHECK (`room_num` > 0)
) ENGINE = InnoDB
  CHARACTER SET = utf8mb3
  COLLATE = utf8mb3_general_ci
  ROW_FORMAT = DYNAMIC;
...
-- Records of stayinfo
-- ----------------------------
INSERT INTO `stayinfo`
VALUES ('202008010218', 'TM39', 2, 106, '2020-09-01');
INSERT INTO `stayinfo`
VALUES ('202108010202', 'TM25', 1, 428, '2021-09-01');
INSERT INTO `stayinfo`
VALUES ('202108010206', 'TM25', 1, 428, '2021-09-01');
INSERT INTO `stayinfo`
VALUES ('202108010214', 'TM316', 7, 433, '2021-09-01');
INSERT INTO `stayinfo`
VALUES ('202108010229', 'TM39', 2, 106, '2021-09-01');
...
-- ----------------------------
INSERT INTO `student`
VALUES ('202008010206', '0206', '阿梅', '男', 2001, 2020, '信息科学与工程学院', '计科2002', '15651516155', '否');
INSERT INTO `student`
VALUES ('202008010214', '0214', '阿政', '女', 2002, 2020, '信息科学与工程学院', '计科2001', '13692875100', '否');
INSERT INTO `student`
VALUES ('202008010218', '0218', '小强', '男', 2002, 2020, '信息科学与工程学院', '计科2102', '13692873211', '否');
INSERT INTO `student`
VALUES ('202108010202', '0202', '小刘', '男', 2002, 2021, '信息科学与工程学院', '计科2102', '13692871011', '是');
INSERT INTO `student`
VALUES ('202108010206', '0206', '小梅', '男', 2002, 2021, '信息科学与工程学院', '计科2102', '13692871022', '是');
INSERT INTO `student`
VALUES ('202108010214', '0214', '小黄', '女', 2003, 2021, '信息科学与工程学院', '计科2102', '13692871033', '是');
INSERT INTO `student`
VALUES ('202108010218', '0218', '小龙', '女', 2003, 2021, '信息科学与工程学院', '计科2102', '13692875111', '是');
INSERT INTO `student`
VALUES ('202108010229', '0229', '小袁', '男', 2002, 2021, '信息科学与工程学院', '计科2102', '13692873222', '是');
INSERT INTO `student`
VALUES ('202108010231', '0231', '小森', '男', 2002, 2021, '信息科学与工程学院', '计科2102', '13692873033', '否');
...
-- ----------------------------
INSERT INTO `teacher`
VALUES ('2001', '波波', '男', '200101');
INSERT INTO `teacher`
VALUES ('2002', '圆周率', '男', '200202');
INSERT INTO `teacher`
VALUES ('2003', '易学军', '男', '200303');
INSERT INTO `teacher`
VALUES ('2004', '李美姮', '女', '200404');
INSERT INTO `teacher`
VALUES ('2005', '凌纯清', '女', '200505');
INSERT INTO `teacher`
VALUES ('2006', '黄丽达', '女', '200606');
INSERT INTO `teacher`
VALUES ('2007', '杨超', '女', '200707');

-- ----------------------------
-- View structure for adminview_advice
-- ----------------------------
DROP VIEW IF EXISTS `adminview_advice`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `adminview_advice` AS
select `advice`.`stu_num`  AS `stu_num`,
       `student`.`name`    AS `name`,
       `advice`.`info`     AS `info`,
       `floor`.`admin_num` AS `admin_num`
from (((`advice` join `student` on ((`advice`.`stu_num` = `student`.`stu_num`))) join `stayinfo`
       on ((`advice`.`stu_num` = `stayinfo`.`stu_num`))) join `floor`
      on ((`stayinfo`.`floor_num` = `floor`.`floor_num`)));

-- ----------------------------
-- View structure for adminview_student
-- ----------------------------
DROP VIEW IF EXISTS `adminview_student`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `adminview_student` AS
select `student`.`stu_num`    AS `stu_num`,
       `student`.`password`   AS `password`,
       `student`.`name`       AS `name`,
       `student`.`sex`        AS `sex`,
       `student`.`birth`      AS `birth`,
       `student`.`grade`      AS `grade`,
       `student`.`faculty`    AS `faculty`,
       `student`.`class`      AS `class`,
       `student`.`phone`      AS `phone`,
       `student`.`yes_no`     AS `yes_no`,
       `stayinfo`.`floor_num` AS `floor_num`
from (`student` join `stayinfo` on ((`student`.`stu_num` = `stayinfo`.`stu_num`)));

-- ----------------------------
-- View structure for student_advice
-- ----------------------------
DROP VIEW IF EXISTS `student_advice`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `student_advice` AS
select `advice`.`stu_num` AS `stu_num`, `student`.`name` AS `name`, `advice`.`info` AS `info`
from (`student` join `advice` on ((`student`.`stu_num` = `advice`.`stu_num`)));

-- ----------------------------
-- View structure for student_inout
-- ----------------------------
DROP VIEW IF EXISTS `student_inout`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `student_inout` AS
select `in_out`.`stu_num`   AS `stu_num`,
       `student`.`name`     AS `name`,
       `in_out`.`floor_num` AS `floor_num`,
       `in_out`.`category`  AS `category`,
       `in_out`.`time`      AS `time`
from (`student` join `in_out` on ((`student`.`stu_num` = `in_out`.`stu_num`)));

-- ----------------------------
-- View structure for student_repair
-- ----------------------------
DROP VIEW IF EXISTS `student_repair`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `student_repair` AS
select `repair`.`stu_num`   AS `stu_num`,
       `student`.`name`     AS `name`,
       `repair`.`floor_num` AS `floor_num`,
       `repair`.`layer`     AS `layer`,
       `repair`.`room_num`  AS `room_num`,
       `repair`.`info`      AS `info`,
       `repair`.`yes_no`    AS `yes_no`
from (`student` join `repair` on ((`student`.`stu_num` = `repair`.`stu_num`)));

-- ----------------------------
-- View structure for student_stayinfo
-- ----------------------------
DROP VIEW IF EXISTS `student_stayinfo`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `student_stayinfo` AS
select `student`.`stu_num`    AS `stu_num`,
       `student`.`name`       AS `name`,
       `stayinfo`.`floor_num` AS `floor_num`,
       `stayinfo`.`layer`     AS `layer`,
       `stayinfo`.`room_num`  AS `room_num`,
       `stayinfo`.`time`      AS `time`
from (`student` join `stayinfo` on ((`student`.`stu_num` = `stayinfo`.`stu_num`)));
